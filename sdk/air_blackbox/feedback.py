...
def record_feedback(scan_id: str, article: int, severity: str, feedback_text: str) -> ComplianceFeedback:
...
def collect_feedback_batch(feedback_items: List[Dict[str, Any]]) -> List[ComplianceFeedback]:
    ...
    logger.info("batch_feedback_processed", extra={"total": len(feedback_items), "failed": failed_count})
