...
def replay_operation(operation_record: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info("operation_replay_started", extra={"operation": operation_record.get("operation")})
...
def generate_audit_summary(records: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.info(
            "audit_summary_generated", extra={"total": total_records, "successful": successful, "failed": failed}
        )
