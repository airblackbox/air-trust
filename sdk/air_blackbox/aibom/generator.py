...
class AIBOMGenerator:
    ...
    def validate_component_data(self, component_name: str, article: int, risk_level: str) -> bool:
    ...
    def add_component(self, component_name: str, article: int, risk_level: str, documentation: str) -> AIBOMEntry:
        ...
        try:
            ...
            logger.info(
                ...
                extra={"component": component_name, "article": article, "risk_level": risk_level},
            )
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        try:
            if not self.entries:
                ...
                return {"components_count": 0, "entries": [], "generated_at": datetime.utcnow().isoformat()}
            ...
            logger.info("aibom_report_generated", extra={"components": len(self.entries)})
